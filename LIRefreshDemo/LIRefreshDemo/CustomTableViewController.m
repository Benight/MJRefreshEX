...
@interface CustomTableViewController ()<MJRefreshEXDelegate>
...
- (void)viewDidLoad {
    ...
    [self.tableView addHeaderWithHeaderClass:@"CustomRefreshHeader" beginRefresh:YES delegate:self animation:YES];
